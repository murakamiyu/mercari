Rails.application.routes.draw do
  ...
  get 'mypages/top', to: 'mypages#mypage'
  get 'mypages/notification', to: 'mypages#mypage_notification'
  get 'mypages/todo', to: 'mypages#mypage_todo'
  get 'mypages/like/history', to: 'mypages#mypage_like_history'
  get 'mypages/listings/listing', to: 'mypages#mypage_listings_listing'
  get 'mypages/listings/in_progress', to: 'mypages#mypage_listings_in_progress'
  get 'mypages/listings/completed', to: 'mypages#mypage_listings_completed'
  get 'mypages/purchase', to: 'mypages#mypage_purchase'
